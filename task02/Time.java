...
/*
Класс Time содержит поля для хранения секунд, минут и часов.
Установка этих полей происходит с помощью методов set_hh, set_mm и set_ss.
Методы выполняют валидацию данных – при некорректном значении параметра выставляется ноль.
*/
public class Time {
...
/*
Метод add_seconds(int) добавляет к текущему времени заданное число секунд, при этом учитывается возможность "переноса" в разряд минут и часов.
*/
